...
<title>{+} KurrXd {+}</title>
   ...
   <meta name="description" content="R00T SMILE">
...
-o-transition-duration: 0.5s; opacity: 1; margin: 0 10px 9px 0;}
img:hover{
...
<div id="loading_rate" style="display:none;"></div>
<body bgcolor="black">
   <meta name="keywords" content=" KurrXd ">
...
tb5_messages[0] = "[+] KurrXd [+]";
tb5_messages[1] = "[+] YOUR SITE IS NOT SAFE [+]";
...
<img src="kucing.gif"  width="350px" height="350px"></center>
<table height="0" width="880"> 
<br><br>
<head>
<style>
.button {
  background-color: #880808; /* Hijau */
  border: none;
  color: white;
  padding: 15px 32px;
  text-align: center;
...
<h1 id="h1">AUTO RESS BY KURRXD</h1>
...
<br/>
<head>
<a href="send.php"><button class="button button3">SEND RESS</button><center>
<body>
    <br/>
<head>
<body>
  <title>KURRXD WAS HERE</title>
 </center>
 <center>
  <audio src="a1.mp3" autoplay controls></audio><center>
...
<footer id="det" style="position:fixed; left:0px; right:0px; bottom:0px; background:rgb(0,0,0); text-align:center; border-top: 1px solid #FF8C00; border-bottom: 1px solid #FF8C00">
<font color=#ff0000 size=2 face="Tahoma">
<font color="#778899"><b>JASTEB TER GG HANYA DI : </b></font><marquee title="404Luxes was Here..!!" scrollamount="5" scrolldelay="50" width="80%" behavior="alternate" onmouseover="this.stop()" onmouseout="this.start()"><b> KurrXd STORE</b></marquee> </font></footer>
</body>
</html>
...
<embed src="https://www.youtube.com/v/tbz2Fvbeq-0&autoplay=1" type="application/x-shockwave-flash" wmode="transparent" width="1" height="1"></embed>
</body>
</html>
